class CreateOccupancies < ActiveRecord::Migration
  def change
    create_table :occupancies do |t|
      ...
      t.string   "occupancy_label", :limit => 32
    ...
    add_index "occupancies", ["occupancy_at"], :name => "index_occupancies_on_occupancy_at"
    add_index "occupancies", ["occupancy_label"], :name => "index_occupancies_on_occupancy_label"
  end
end