class CreateSalesLeads < ActiveRecord::Migration
  def change
    create_table :sales_leads do |t|
      ...
      t.integer  "lead_source_id", :default => 0, :null => false
      ...
      t.string   "competing_cities", :limit => 64
      ...
      t.boolean  "hide_sales_lead", :default => false, :null => false
    ...
    add_index "sales_leads", ["data_source_id"], :name => "index_sales_leads_on_data_source_id"
    add_index "sales_leads", ["meeting_id"], :name => "index_sales_leads_on_meeting_id"
    add_index "sales_leads", ["meeting_status_id"], :name => "index_sales_leads_meeting_status_id"
    add_index "sales_leads", ["organization_id"], :name => "index_sales_leads_on_organization_id"
  end
end